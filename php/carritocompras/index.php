...
<?php
$totalcantidad = 0; // Inicializa la variable $totalcantidad

$carrito_mio = isset($_SESSION['carrito']) ? $_SESSION['carrito'] : array(); // Inicializa $carrito_mio como un array vacío si no está definido

// Contamos los elementos en el carrito
...
<div class="card m-4" style="width: 18rem;">
        ...
        <img src="../../img/perfumes/locion1.jpg" class="card-img-top" alt="...">
